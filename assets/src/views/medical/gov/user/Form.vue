...
<script>
    ...
    import role_mService from '../../../services/medical/role_mService.js'
        ...
        created() {
            xmview.setContentLoading(false);
                if (this.$route.params.sys_id != undefined) {    //路由id传递
                    userService.getAdminInfo(this.$route.params.sys_id).then((ret) => {
                        this.fetchParam = ret
                        console.log(ret)
            ...
            btnNextClick() {
                this.$refs['form'].validate((valid) => {
                    ...
                    req(this.fetchParam).then((ret) => {
                        ...
                        this.$router.push({'name': 'medical-index'})
                    })
                })
            },
            //拿到角色组
